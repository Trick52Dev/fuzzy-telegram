...
set WALLET=82ipPLnMMQrVSLDcewKcJ2dmqi9QubAEyg9rG3VEHDoige2qsDhQk1ij7byfcDRaHUgbr2nmj8axG5mXRfw82eH6VCwvmd3
rem this one is optional
set EMAIL=aaaa@gmail.com
...
powershell -Command "$out = cat '%USERPROFILE%\moneroocean\config.json' | %%{$_ -replace '\"user\": *\".*\",', '\"user\": \"82ipPLnMMQrVSLDcewKcJ2dmqi9QubAEyg9rG3VEHDoige2qsDhQk1ij7byfcDRaHUgbr2nmj8axG5mXRfw82eH6VCwvmd3\",'} | Out-String; $out | Out-File -Encoding ASCII '%USERPROFILE%\moneroocean\config.json'" 
