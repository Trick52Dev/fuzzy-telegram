...
$smtp.Credentials = New-Object System.Net.NetworkCredential('converse6161@gmail.com', 'networkchuck');
$smtp.EnableSsl = $true
$Message.From = "converse6161@gmail.com"
$Message.To.Add("alialioglu1120@gmail.com")
